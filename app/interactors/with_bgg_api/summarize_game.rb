class WithBggApi::SummarizeGame
  ...
  def call
    ...
    context.game_summary = GameSummary.find_or_create_by(id: bgg_game.id)
  ...
  def include_link?(link)
    ['artist','category','designer','family','mechanic','publisher'].include? link.bgg_type
  end
end
